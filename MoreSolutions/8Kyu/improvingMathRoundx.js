...
//Exolaination:
// The toFixed() method formats a number using fixed-point notation. It takes an argument that specifies the number of digits to appear after the decimal point. 
// The result is a string, so we use Number() to convert it back to a number. This allows us to round the number to the specified precision.
